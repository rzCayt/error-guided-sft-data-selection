"""Create one immutable, CPU-only audit artifact for a v3 Phase 1 cell."""
...
from eg_sft.experiment.budget_equivalent_audit import audit_phase1_run  # noqa: E402
