"""Merge and audit all arithmetic OOD outputs from raw model text."""
...
def _audit_dataset(
    *, config_path: Path, run_dir: Path, dataset: str, shard_count: int
    ...
    return {
        ...
        "parser_rows_recomputed_from_raw_text": report[
...
def main() -> None:
    ...
    final = {
        "audit_schema_version": "budget-equivalent-ood-audit-v2-raw-recompute",
        "status": "PASS",
    ...
    print(
        json.dumps(
            {
                "status": "PASS",
                "stage": "budget_equivalent_ood_audit_v2",
