"""Write one immutable blind-safe audit with its audit-code commit."""
...
def main() -> None:
    ...
    report["audit_schema_version"] = "budget-equivalent-cell-audit-v5-blind-safe"
    report["audit_code_commit"] = _git_commit()
